...
class MetricsTracker:
    ...
    def update(
        self, i, view_img, output_base, output_tpt, target, loss_value, writer, args
    ):
        ...
        writer.add_scalar(
            "crossEntropy/difference(base-TPT)", base_crossEntropy - tpt_crossEntropy, i
        )
        ...
        writer.add_scalar(
            "AccuracyTOP1/difference(TPT-base)", curr_TPTcoop_acc - curr_base_acc, i
        )
    ...
    def write_info(self, writer, args):
        ...
        for target in range(args.nclasses):
            ...
            global_stat["tpt_improved_samples"] += self.sample_statistics[target][
                "tpt_improved_samples"
            ]
            global_stat["tpt_worsened_samples"] += self.sample_statistics[target][
                "tpt_worsened_samples"
            ]
